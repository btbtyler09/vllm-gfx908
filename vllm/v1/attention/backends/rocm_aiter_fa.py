    ...
    def forward(
        ...
        if not attn_metadata.use_cascade:
            ...
            if num_decodes > 0:
                ...
                # sinks).
                # gfx908 also takes this path: ll4mi is gated to gfx90a+ and
                # Triton PA decode exceeds MI100 64KB LDS with block_size=528
                # (gluon also needs the shuffle KV layout, never enabled here).
